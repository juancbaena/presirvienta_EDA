...
La exploración, la visualización, y la interpretación de los hallazgos de esta base de datos, realizados todos empleando el lenguaje de programación R, se presentan a continuación:
