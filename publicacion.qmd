...
La exploración, la visualización, y la interpretación de los hallazgos de esta base de datos[^1], realizados todos empleando el lenguaje de programación R, se presentan a continuación:

[^1]: Los datos y la programación empleada, se encuentra en el repositorio: <https://github.com/juancbaena/presirvienta_EDA>
...
Los bigramas acomodados por día sus frecuencias, es posible observar que el día 2 de Octubre se repiten bigramas con adjetivos calificativos hacia la presidenta, en los otros días, exceptuando el 7, la combinación dígan presirvienta aparece con mayor frecuencia.

Gráfica por emocion

```{r bigrama_emocion, echo=FALSE}
...
En este conjunto de gráficos es posible observar que la emoción con mayor densidad de bigramas es tristeza y en segundo lugar es sorpresa. De ggual manera aparece el nombre de la presidenta como bigrama con más ocurrencias.
